...
def build_fundamentals(info, income, balance, cashflow):
    ...
    if free_cash_flow is None and operating_cash_flow is not None and capex is not None: free_cash_flow = operating_cash_flow - abs(capex)
